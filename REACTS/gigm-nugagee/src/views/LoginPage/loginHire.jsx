...
export const LoginThreeComponent = () => {
  ...
  const modalBody = (
    <div>
      ...
      <Button
        ...
        handleButtonClick={toggleModalAgain}
        type="button"
      />
    </div>
  );
  ...
  const modalParTwo =
    "Hi there, we just sent a verification code to your provided email or phone number";
  const modalBodyTwo = (
...
export default LoginThreeComponent;
